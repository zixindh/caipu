...
为喜欢的人认真安排每一顿饭。Eva、Heng 和强尼共用这份中文七日菜单；应用会滚动显示从今天开始的 7 天，每天包含早餐、午餐和晚餐，并自动汇总尚未备齐的食材。

## 功能

- 点击 Eva、Heng 或强尼的名字立即进入，无需密码或第二次确认
- 一张表同时展示并编辑 7 天 × 3 餐，不用逐日点击
- 手机端使用短日期、紧凑列宽和自动换行，优先显示菜品与食材
- 每餐记录菜品、食材和备注，提议人根据当前登录者自动填写
- Eva、Heng、强尼使用固定紫、蓝、橙色标记，表格和历史一致
- 每餐独立标记“食材已购买或冰箱已有”
- 自动生成采购清单，合并重复食材
- 只有保存和手动刷新时访问 Notion，减少等待和界面卡顿
- 每天自动滚动：始终显示今天起 7 天，次日自动加入新的空白日期
- 按需查看往期灵感，默认最近 30 天，可逐步加载更早菜单
- 手机和电脑都可使用
...
- 在登录页点击 Eva、Heng 或强尼的名字，即可直接进入餐单。
- 进入后直接在七日表格中编辑早餐、午餐和晚餐。
- 输入后按 Enter 或离开单元格即自动写入 Notion，不需要额外保存按钮。
- 家人修改后，点击页面右上角“刷新”获取最新版本。
- 如果食材已经买好或冰箱里已有，打开该餐的“食材已购买或冰箱已有”。
- “采购清单”只显示尚未备齐的餐次所需食材。
- “往期灵感”按日期查看过去填写过的菜单；历史只读，不会误改旧记录。
